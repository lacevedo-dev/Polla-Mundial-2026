...
export default function FootballSyncHistory() {
  ...
  return (
    <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-xl sm:text-2xl font-black text-slate-900 font-brand uppercase tracking-tight leading-tight">Historial de Sync</h1>
          <p className="text-xs text-slate-400 mt-1">Registro de todas las operaciones de sincronización</p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              >
                ...
                {SyncHistoryTypeOptions.map((option) => (
