                                        ...
                                        {activeLeague.participants.max > PLAN_LIMITS[activeLeague.plan] && (
                                            <div className="flex items-start gap-2 p-2 bg-rose-50 rounded-xl border border-rose-100">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <Button size="sm" className="h-7 text-[8px] bg-rose-500 hover:bg-rose-600 text-white w-full mt-1" onClick={() => { setShowConfigModal(false); navigate('/checkout'); }}>MEJORAR PLAN AHORA</Button>
                                                </div>
                                            </div>
                                        )}
                                    </div>
