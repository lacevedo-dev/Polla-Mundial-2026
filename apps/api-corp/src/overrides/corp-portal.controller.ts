...
import { UpdateTenantBrandingDto } from '@corp-api/corporate-tenant/dto/tenant.dto';
import { UpdateMemberDto } from '@corp-api/corporate-tenant/dto/update-member.dto';
import { BrandingStorageService, BrandingUploadFile } from '@corp-api/corporate-tenant/branding-storage.service';
        ...
        return {
            ...
            knockoutAdvance: {
                ...
                summary:
                    ...
                    + 'Eso influye en el bono clasificados por fase (+12 en dieciseisavos, +8 en octavos si aciertas todos los picks de la ronda). '
