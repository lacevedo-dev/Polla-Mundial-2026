  ...
  async getStatus() {
    ...
    const schedulers = [
      ...
      },
      {
        ...
        cron: 'Football Sync',
        description: 'Al detectar tarjeta amarilla vía polling /fixtures/events (requiere event sync + eventWaYellowCardEnabled)',
        notifType: null,
        icon: '🟨',
        audience: 'Grupos WA de ligas con predicciones en el partido',
        channels: ['waGroup'],
      },
      {
        ...
        cron: 'Football Sync',
        description: 'Al detectar cambio vía polling /fixtures/events (requiere event sync + eventWaSubstitutionEnabled)',
        notifType: null,
        icon: '🔄',
        audience: 'Grupos WA de ligas con predicciones en el partido',
        channels: ['waGroup'],
