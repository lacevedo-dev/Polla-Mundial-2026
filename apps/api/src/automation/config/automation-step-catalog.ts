...
export const AUTOMATION_STEP_CATALOG: AutomationStepCatalogEntry[] = [
  ...
  {
    key: AutomationStep.GOAL_SCORED,
    phase: 'LIVE',
    label: 'Gol en vivo',
    shortLabel: 'Gol',
    description: 'Al detectar cambio de marcador vía /fixtures — complementa con /fixtures/events',
    schedulerId: 'live_goal',
    channels: ['push', 'inApp', 'waGroup'],
    defaultEnabled: true,
  },
  {
  ...
  {
    key: AutomationStep.YELLOW_CARD,
    phase: 'LIVE',
    label: 'Tarjeta amarilla',
    shortLabel: 'TA',
    description: 'Al detectar tarjeta amarilla vía /fixtures/events en el sync programado',
    schedulerId: 'live_yellow_card',
    channels: ['waGroup'],
    defaultEnabled: true,
  },
  {
    key: AutomationStep.RED_CARD,
    phase: 'LIVE',
    label: 'Tarjeta roja',
    shortLabel: 'TR',
    description: 'Al detectar tarjeta roja vía /fixtures/events en el sync programado',
    schedulerId: 'live_red_card',
    channels: ['waGroup'],
    defaultEnabled: true,
  },
  {
    key: AutomationStep.SUBSTITUTION,
    phase: 'LIVE',
    label: 'Cambio',
    shortLabel: 'Camb.',
    description: 'Al detectar sustitución vía /fixtures/events en el sync programado',
