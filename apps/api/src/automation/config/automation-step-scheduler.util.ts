...
> = {
  ...
  [AutomationStep.GOAL_SCORED]: 'live_goal',
  [AutomationStep.GOAL_IMPACT]: 'live_goal_impact',
  [AutomationStep.YELLOW_CARD]: 'live_yellow_card',
  [AutomationStep.RED_CARD]: 'live_red_card',
  [AutomationStep.SUBSTITUTION]: 'live_substitution',
